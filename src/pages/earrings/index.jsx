...
const Earrings = () => {
  ...
  const handleWishDelete = (id) => {
    axios
      .delete(`https://charming-bee-pea-coat.cyclic.app/wishlist/${id}`)
      .then((res) => console.log(res))
      .catch((error) => console.log(error));
  };
      ...
      <div>
        ...
        <Box>
          <Flex direction="column">
            <Box>
              <Image
                src="https://banner.caratlane.com/live-images/4320a30823014770b49d6c35ba3508c9.jpg"
                alt="Banner Image"
                width={1920}
                height={560}
              />
                ...
                <Box p="20px">
                  ...
                  >
                    ...
                    <Stack spacing="2" direction="column">
                      ...
                      <Checkbox value="Gemstone">
                        <Text className={styles.filterCheck}>Gemstone</Text>
                      </Checkbox>
                      <Checkbox value="Gold">
                        <Text className={styles.filterCheck}>Gold</Text>
                      </Checkbox>
                      <Checkbox value="Pearls">
                        <Text className={styles.filterCheck}>Pearl</Text>
                      </Checkbox>
                    </Stack>
                  </CheckboxGroup>
                </Box>
